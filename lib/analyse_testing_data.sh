...
iupred(){
    ...
    python3.7 lib/iupred_feature.py --fh_in $analysis_folder/${jobname}_iupred.tab \
	      --fh_out analysis/${jobname}_iupred_feature.csv
}

amino_acid_composition(){
    python3.7 lib/amino_acid_comp.py --fh_in $fasta_seqs --fh_out analysis/${jobname}_amino_acid_comp.csv
}
...
combine_features(){
    python3.7 lib/combine_feature.py --fasta_fh $fasta_seqs \
	      ...
	      --iupred_fh analysis/${jobname}_iupred_feature.csv \
	      --hydro_charge_fh $analysis_folder/${jobname}_charge_hydro.csv \
	      --aa_comp_fh analysis/${jobname}_amino_acid_comp.csv \
